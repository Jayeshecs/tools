...
public class StatementSource_IntegTest extends SimpleModuleIntegTestAbstract {
    ...
    public void setUp() {
        // given
        category = fixtureScripts.runBuilderScript(StatementSource_persona.HDFC_1668.builder());
    }

    public static class Name extends StatementSource_IntegTest {
    ...
    public static class UpdateName extends StatementSource_IntegTest {
    ...
    public static class Title extends StatementSource_IntegTest {
    ...
    public static class DataNucleusId extends StatementSource_IntegTest {
    ...
    public static class DataNucleusVersionTimestamp extends StatementSource_IntegTest {
