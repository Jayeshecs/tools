 ...
 */
public class StatementsModuleManifest extends AppManifestAbstract2 {

    public static final Builder BUILDER = Builder.forModule(new StatementsModule())
    ...
    public StatementsModuleManifest() {
        super(BUILDER);
    }
