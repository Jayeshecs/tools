    ...
    protected Module newIsisWicketModule() {
        ...
        final Module overrides = new AbstractModule() {
            ...
            protected void configure() {
                ...
                bind(String.class).annotatedWith(Names.named("welcomeMessage")).toInstance(readLines(getClass(), "welcome.html", "This is an application to manage statements"));
